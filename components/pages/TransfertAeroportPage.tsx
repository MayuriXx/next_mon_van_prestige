...
// Données fallback locales (depuis tarifs.ts)
const AIRPORTS: Airport[] = [
  ...
  },
  {
    id: 'zaventem',
    name: 'ZAVENTEM',
    destination: 'Bruxelles Zaventem',
    businessMin: 190,
    vanMin: 235,
    icon: '✈',
  },
...
const ADVANTAGES = [
  {
    ...
    description:
      'Adaptez votre transfert à vos besoins spécifiques : horaires flexibles, arrêts supplémentaires, assistance VIP.',
    icon: '🎯',
  },
  {
    id: 'punctuality',
    ...
    description:
      'Suivi en temps réel de votre vol. Nous vous attendons dès votre arrivée, peu importe les retards.',
    icon: '⏰',
  },
  {
    id: 'support',
    ...
    description:
      'Équipe dédiquée disponible jour et nuit pour répondre à vos questions et résoudre tout problème.',
    icon: '📱',
  },
];

export default function TransfertAeropurtPage() {
  ...
  useEffect(() => {
    async function loadTarifs() {
      try {
        // TODO: Charger depuis Firestore collection 'tarifs'
        // Pour le moment, on utilise les données locales
          ...
          <div className="container">
            ...
            <div className={styles.badges}>
              <div className={styles.badge}>
                ...
                <span className={styles.badgeText}>Sécurité</span>
              </div>
              <div className={styles.badge}>
                <span className={styles.badgeIcon}>⏱️</span>
                <span className={styles.badgeText}>Ponctualité</span>
              </div>
              <div className={styles.badge}>
                <span className={styles.badgeIcon}>💰</span>
                <span className={styles.badgeText}>Meilleur Tarif</span>
              </div>
            </div>
          </div>
        </div>

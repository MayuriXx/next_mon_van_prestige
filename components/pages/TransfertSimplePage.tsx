...
export default function TransfertSimplePage() {
  ...
  return (
    <>
      {/* ══ HERO — image fond + texte gauche + formulaire droite ══ */}
      ...
      {/* ══ L'EXCELLENCE DU VOYAGE — avantages gauche + carte droite ══ */}
        ...
        <div className="container">
          ...
          <div className={styles.excellenceLayout}>
            ...
            <div className={styles.mapCol}>
              ...
              {/* Stats distance/durée — toujours visible */}
                ...
                <div className={styles.statItem}>
                  ...
                  <div>
                    ...
                    <span className={styles.statValue}>
                      {result ? result.distanceKm.toFixed(1) + ' km' : '-- km'}
                    </span>
                  </div>
                </div>
              ...
              {/* Prix — affiché seulement après calcul */}
              {result && (

...
const CONTENT: Record<Locale, {
  ...
  fr: {
    ...
    note: '* Durée minimum de mise à disposition : 2 heures — forfait de 25 km/h inclus (catégories Van et Business)',
  ...
  en: {
    ...
    note: '* Minimum duration: 2 hours — 25 km/h package included (Van and Business categories)',
  ...
  nl: {
    ...
    note: '* Minimale duur: 2 uur — forfait van 25 km/u inbegrepen (categorieën Van en Business)',
